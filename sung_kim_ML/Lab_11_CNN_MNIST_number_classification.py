...
##    b_conv_l1 = tf.Variable(tf.random_uniform([1, 64], -1.0, 1.0))
    W_conv_l1 = tf.Variable(tf.random_normal([7, 7, 1, 64]))
    b_conv_l1 = tf.Variable(tf.random_normal([1, 64]))
...
##    b_conv_l2 = tf.Variable(tf.random_uniform([1, 64], -1.0, 1.0))
    W_conv_l2 = tf.Variable(tf.random_normal([5, 5, 64, 64]))
    b_conv_l2 = tf.Variable(tf.random_normal([1, 64]))    
...
##    b_conv_l4 = tf.Variable(tf.random_uniform([1, 32], -1.0, 1.0))
    W_conv_l4 = tf.Variable(tf.random_normal([7, 7, 64, 32]))
    b_conv_l4 = tf.Variable(tf.random_normal([1, 32]))
...
##    b_conv_l5 = tf.Variable(tf.random_uniform([1, 32], -1.0, 1.0))
    W_conv_l5 = tf.Variable(tf.random_normal([5, 5, 32, 32]))
    b_conv_l5 = tf.Variable(tf.random_normal([1, 32]))
...
##    b_fc_l7 = tf.Variable(tf.random_uniform([1, 1024], -1.0, 1.0))
    b_fc_l7 = tf.Variable(tf.random_normal([1, 1024]))
...
##    b_fc_l8 = tf.Variable(tf.random_uniform([1, 256], -1.0, 1.0))
    b_fc_l8 = tf.Variable(tf.random_normal([1, 256]))
...
##    b_fc_l9 = tf.Variable(tf.random_uniform([1, 10], -1.0, 1.0))
    b_fc_l9 = tf.Variable(tf.random_normal([1, 10]))
